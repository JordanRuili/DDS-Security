                       ...
                       struct ApplicationSecMaterial *sec_material)
{
    ...
    application = Application_create(PEER_NAME, "publisher", domain_id,
...
subscriber_main(void)
{
    ...
    DDS_Long i = 0,
             ...
             sleep_time = 1000,
             count = 0;
    char *peer = NULL, /* set correct peer, e.g. "10.10.65.103" */
         *udp_intf = NULL;
    struct ApplicationSecMaterial sec_material = PEER_MATERIAL_DEFAULT;
